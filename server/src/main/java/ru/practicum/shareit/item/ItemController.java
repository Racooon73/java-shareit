...
public class ItemController {
    ...
    @PostMapping
    public ItemDto addItem(@RequestBody ItemDto dto, @RequestHeader("X-Sharer-User-Id") long ownerId) throws NotFoundException {
    ...
    public Comment addComment(@RequestBody Comment dto, @PathVariable long itemId,
